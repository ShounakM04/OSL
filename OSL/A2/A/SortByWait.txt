...
int main() {
    ...
    // Declare arrays with normal (automatic) allocation
    int arr[n];  // Array for the original values
    int arr_copy[n];  // Array for the child process to use
    ...
    // Copy the original array to a separate array for child process
    for (int i = 0; i < n; i++) {
        arr_copy[i] = arr[i];
    }
